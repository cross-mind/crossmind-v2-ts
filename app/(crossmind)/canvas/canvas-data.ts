...
export const FRAMEWORKS: ThinkingFramework[] = [
  {
    ...
    zones: [
      { id: "ideation", zoneKey: "ideation", name: "想法孵化", colorKey: "orange", description: "探索和验证产品想法" },
      { id: "design", zoneKey: "design", name: "设计规划", colorKey: "blue", description: "定义产品功能和用户体验" },
      { id: "dev", zoneKey: "dev", name: "开发实现", colorKey: "green", description: "技术实现和测试" },
      { id: "launch", zoneKey: "launch", name: "发布运营", colorKey: "pink", description: "上线和市场推广" },
    ],
  },
  {
    id: "business-canvas",
    ...
    zones: [
      { id: "customer", zoneKey: "customer", name: "客户细分", colorKey: "orange" },
      { id: "value", zoneKey: "value", name: "价值主张", colorKey: "indigo" },
      { id: "channels", zoneKey: "channels", name: "渠道通路", colorKey: "teal" },
      { id: "relationship", zoneKey: "relationship", name: "客户关系", colorKey: "purple" },
      { id: "revenue", zoneKey: "revenue", name: "收入来源", colorKey: "green" },
      { id: "resources", zoneKey: "resources", name: "核心资源", colorKey: "amber" },
      { id: "activities", zoneKey: "activities", name: "关键业务", colorKey: "orange" },
      { id: "partners", zoneKey: "partners", name: "重要合作", colorKey: "pink" },
      { id: "costs", zoneKey: "costs", name: "成本结构", colorKey: "red" },
    ],
  },
  {
    id: "saas-health",
    ...
    zones: [
      { id: "growth", zoneKey: "growth", name: "增长指标", colorKey: "lightGreen", description: "用户增长和获客" },
      { id: "retention", zoneKey: "retention", name: "留存分析", colorKey: "cyan", description: "用户留存和流失" },
      { id: "monetization", zoneKey: "monetization", name: "变现能力", colorKey: "amber", description: "收入和定价策略" },
      { id: "unit-economics", zoneKey: "unit-economics", name: "单位经济", colorKey: "orange", description: "LTV/CAC 等核心指标" },
    ],
  },
  {
    ...
    zones: [
      { id: "white", zoneKey: "white", name: "白帽-事实", colorKey: "cyan", description: "客观数据和信息" },
      { id: "red", zoneKey: "red", name: "红帽-情感", colorKey: "red", description: "直觉和感受" },
      { id: "black", zoneKey: "black", name: "黑帽-风险", colorKey: "indigo", description: "谨慎和风险评估" },
      { id: "yellow", zoneKey: "yellow", name: "黄帽-乐观", colorKey: "amber", description: "积极面和机会" },
      { id: "green", zoneKey: "green", name: "绿帽-创意", colorKey: "green", description: "创造性思维" },
      { id: "blue", zoneKey: "blue", name: "蓝帽-控制", colorKey: "blue", description: "流程控制和总结" },
    ],
  },
  {
    id: "lean-canvas",
    ...
    zones: [
      { id: "problem", zoneKey: "problem", name: "问题", colorKey: "red" },
      { id: "solution", zoneKey: "solution", name: "解决方案", colorKey: "green" },
      { id: "unique-value", zoneKey: "unique-value", name: "独特价值", colorKey: "amber" },
      { id: "unfair-advantage", zoneKey: "unfair-advantage", name: "壁垒优势", colorKey: "purple" },
      { id: "customer-segments", zoneKey: "customer-segments", name: "客户细分", colorKey: "blue" },
      { id: "channels", zoneKey: "channels", name: "渠道", colorKey: "teal" },
      { id: "revenue", zoneKey: "revenue", name: "收入来源", colorKey: "lightGreen" },
      { id: "cost", zoneKey: "cost", name: "成本结构", colorKey: "orange" },
      { id: "key-metrics", zoneKey: "key-metrics", name: "关键指标", colorKey: "indigo" },
    ],
  },
];
